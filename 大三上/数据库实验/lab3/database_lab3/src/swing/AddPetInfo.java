...
import static Main.ImageManager.addPetInfoImage;
...
public class AddPetInfo {
    private JPanel AddPetInfoPanel;
    private JLabel AddPetInfoLabel;
    ...
    public  AddPetInfo(JFrame frame, DB_controller db_ctrl,JTable PetInfoStaffTable,
                       JScrollPane StaffPetScrollPane) throws SQLException {


        AddPetInfoLabel.setIcon(addPetInfoImage);
        ...
        ConfirmButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(wrong_message==0){
                    try {
                        db_ctrl.add_pet_info(pet_type_id,pet_name,pet_gender,pet_birthday,pet_character,pet_color);
